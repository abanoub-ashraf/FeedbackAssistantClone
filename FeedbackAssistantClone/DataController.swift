...
class DataController: ObservableObject {
    ...
    func hasEarned(award: Award) -> Bool {
        switch award.criterion {
            case "issues":
                ///
                /// return true if they added a certain amount of issues
                ///
            ...
            case "closed":
                ///
                /// return true if they closed a certain amount of issues
                ///
                let fetchRequest = Issue.fetchRequest()
            ...
            case "tags":
                ///
                /// return true if they added a certain amount of tags
                ///
